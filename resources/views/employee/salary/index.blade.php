...
<section class="rounded-section">
    <div class="container my-4">
        ...
        <form method="GET" class="mb-3 row g-2">
            ...
            <div class="col-md-3">
                <button type="submit" class="btn btn-auth-login">Lihat</button>
            </div>
        </form>
        @if(session('error'))
        ...
        <a href="{{ route('salary.download', auth()->user()->id) }}" class="btn btn-auth-logout btn-sm mt-3">⬇ Unduh Slip Gaji PDF</a>
    </div>
</section>
@endsection
